...
import { IconCheck, IconExclamationTriangleSolid } from 'dls-icons-react';
...
const Progress: React.FC<ProgressProps> = (props: ProgressProps) => {
  ...
  const getProgressInfo = () => {
    ...
    if (status === 'exception') text = <IconExclamationTriangleSolid />;
    else if (status === 'success') text = <IconCheck />;
    return (
      <span
